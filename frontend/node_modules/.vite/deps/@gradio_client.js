...
async function Ct(e, s, t) {
  ...
  try {
    ...
    if (typeof process < "u" && process.versions && process.versions.node) {
      const p = await import("./__vite-browser-external-DYxpcVy9-TYBWYDTX.js");
      i = (await import("./__vite-browser-external-DYxpcVy9-TYBWYDTX.js")).resolve(process.cwd(), n.meta.path), r = await p.readFile(i);
    } else
      throw new Error(ut);
    const a = new Blob([r], {
